...
- PyTorch 2.3.1, torchvision 0.18.1, torchaudio 2.3.1 (CUDA 12.1)
...
# Test specific group
pytest -k "pytorch-cu121-training"

# Test specific group import test
pytest tests/test_imports.py::TestImports::test_all_imports -k "pytorch-cu121-training"
```
